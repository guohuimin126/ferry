    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
                    	<span class="red"><?php echo $data['job_money_min'];?></span>
                       	<span><?php echo $data['job_address'];?></span>
                       	<span>经验3-5年 </span>
                       	<span> <?php echo $data['ed_bg'];?></span>
                       	<span>全职</span><br />
                      	  职位诱惑 : <?php echo $data['job_special'];?>
                      	<div>发布时间：<?php echo $data['add_time'];?>前发布</div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p>岗位职责：
                            <?php foreach($data['arr'] as $k=>$v){?>
                            <br />
                                <?php echo $v;?>
                            <?php }?>
