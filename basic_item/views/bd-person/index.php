    ...
    <div id="container">
        ...
        <div id="sidebar">
            <div class="mainNavs">
                ...
                <div class="menu_box">
                    <div class="menu_main">
                        <h2><?php echo $k?><span></span></h2>
                        <?php  $shu=0; foreach ($v as $kk=>$vv) { $shu=$shu+1;$num=0; if(is_array($vv)){foreach ($vv as $kkk=>$vvv){ $num=$num+1;if($shu<8&&$num<2){?>
                        <a href="?r=bd-person/job&c_id=<?php echo $vvv ?>"><?php echo $kkk?></a>
                        <?php }}}}?>
                    </div>
                    <div class="menu_sub dn">
                        ...
                        <dl class="reset">
                            ...
                            <dd>
                                <?php  if(is_array($vv)){foreach($vv as $kkk=>$vvv) {  ?>
                                <a href="?r=bd-person/job&c_id=<?php echo $vvv ?>"
        ...
        <div class="content">
            <div id="search_box">
                <form  action="" method="get">
                    <input type="hidden" name="r" value="bd-person/search"/>
                    <ul id="searchType">
